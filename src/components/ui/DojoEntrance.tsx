  ...
  return (
    <div className="w-full h-full relative bg-[#F5E6D3]">
      ...
      <svg className="absolute inset-8 w-[calc(100%-4rem)] h-[calc(100%-4rem)] opacity-5">
        <pattern id={`grid-${side}`} width="40" height="40" patternUnits="userSpaceOnUse">
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            initial={{ opacity: 0, x: type === 'bokken' ? 20 : -20, scale: 0.95 }}
          ...
          >
            ...
            <div className="bg-japan-blue p-4">
              <h3 className="font-jp text-2xl text-washi">{weaponInfo.title}</h3>
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Outer frame */}
        <div className="w-48 h-64 md:w-64 md:h-80 lg:w-80 lg:h-96 bg-[#1a1a1a] p-2 shadow-2xl">
          {/* Inner frame */}
          <div className="w-full h-full bg-gradient-to-b from-[#2a2a2a] to-[#1a1a1a] p-1">
            ...
            <div className="w-full h-full bg-gradient-to-br from-[#3a3a3a] via-[#2a2a2a] to-[#1a1a1a] relative overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.span
                  className="font-jp text-6xl md:text-7xl lg:text-8xl text-washi/10"
                  initial={{ opacity: 0 }}
        ...
        >
          ...
          <p className="text-xs text-[#DEB887] text-center tracking-wider">O-SENSEI</p>
        </motion.div>
      </div>
    </motion.div>
  );
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#1a1a1a]">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#2a2a2a] to-[#1a1a1a]">
          ...
          <svg className="absolute inset-0 w-full h-full opacity-10">
            <pattern id="woodPattern" width="100" height="20" patternUnits="userSpaceOnUse">
              <path
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#2F2F2F] via-[#252525] to-[#1a1a1a]">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1/3 opacity-20">
              <svg width="100%" height="100%">
                <pattern id="tatamiInterior" width="60" height="30" patternUnits="userSpaceOnUse">
                  <rect width="60" height="30" fill="#5D4E37" />
                  <line x1="0" y1="15" x2="60" y2="15" stroke="#4A3F2F" strokeWidth="0.5" />
                  <line x1="30" y1="0" x2="30" y2="30" stroke="#4A3F2F" strokeWidth="0.5" />
                </pattern>
          ...
          {/* Weapon Racks */}
          <WeaponRack type="bokken" isVisible={doorsOpen} weaponInfo={bokkenInfo} />
        ...
        >
          <div className="relative">
            ...
            {/* Main circle */}
            <div className="relative w-40 h-40 md:w-56 md:h-56 lg:w-72 lg:h-72 rounded-full bg-washi shadow-2xl flex items-center justify-center">
              {/* Inner ring */}
              ...
              <div className="text-center">
                ...
                >
                  <Image src="/images/dojos/dojo.png" alt="dojo" width={80} height={80} />
                </motion.span>
              </div>
